...
/**
 * Configuration constants for tab icons
 */
        ...
        style={[
          {
            ...
            alignItems: "center",
            marginTop: containerSize * TAB_ICON_CONFIG.CAMERA.MARGIN_TOP_RATIO,
          },
          containerStyle,
        ]}
        accessibilityRole="button"
        accessibilityLabel={accessibilityLabel || "Camera"}
      >
        <View
          style={{
            width: containerSize - TAB_ICON_CONFIG.CAMERA.PADDING,
            height: containerSize - TAB_ICON_CONFIG.CAMERA.PADDING,
            borderRadius: containerSize / 2,
        ...
        >
          <BaseIcon
            size={25}
            viewBox={TAB_ICON_CONFIG.DEFAULT.VIEW_BOX}
            accessibilityLabel={accessibilityLabel || "Camera"}
            {...props}
          >
            <Path d={TAB_ICON_PATHS[name]} fill="white" />
          </BaseIcon>
        </View>
      </View>
    );
